...
let Category = class Category extends base_modifiable_without_identity_entity_1.BaseModifiableEntityWithoutIdentity {
};
...
__decorate([
    (0, typeorm_1.Column)({
        type: "varchar",
        length: _core_constants_1.CategoryEntityConstant.NameMaxLength,
        name: "name",
        nullable: false
    }),
    __metadata("design:type", String)
...
exports.Category = Category = __decorate([
    ...
    (0, typeorm_1.Unique)(_core_constants_1.DatabaseUniqueKey.CategoryName, ["name"])
], Category);
