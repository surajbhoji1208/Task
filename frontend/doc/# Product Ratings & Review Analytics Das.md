...
#API flow digram 
`/home/suraj-web/Desktop/node-boilerplate/task-f/auth-api-flow-diagram.md `
`/home/suraj-web/Desktop/node-boilerplate/task-f/user-api-flow-diagram.md`
`/home/suraj-web/Desktop/node-boilerplate/task-f/product-analytics-api-flow-diagram.md`
reveiw this api flow diagram and integrate them properly 

#bussiness rule
`/home/suraj-web/Desktop/node-boilerplate/task-f/coding-standards-rules.md `
`/home/suraj-web/Desktop/node-boilerplate/task-f/architecture-rules.md`
stricktly follow these rule